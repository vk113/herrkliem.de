<script>
    ...
    $: n_of_arrows = Math.max(2, Math.floor(e_field.w/max_density*Math.min(Math.abs(e_field.E.y), $E_max)/$E_max));
...
<Movable bind:t={e_field.t} bind:l={e_field.l} bind:w={e_field.w} bind:h={e_field.h} resizable  on:move>
    ...
    <div slot="content" >
        ...
        <div class="absolute top-[10%] h-[80%] w-full border-2 border-green-500 overflow-hidden opacity-80">
                    ...
                    <g transform="matrix(1,0,0,1,0,4.144e-05)">
                        <g id="ArtBoard1" transform="matrix(1,0,0,0.980632,-744.06,-202.579)">
                            ...
                            <g transform="matrix(1,0,0,1.01975,-15.4388,-57.2451)">
                                <path class="stroke-current" d="M1153.82,318.152L1153.82,2885.83" style="fill:none;stroke-width:40px;"/>
                            </g>
                            <g transform="matrix(1,0,0,1.01975,91.1739,79.2564)">
                                <path class="stroke-current" d="M907.733,2636.54L1048.33,2754.74L1188.05,2633.01" style="fill:none;stroke-width:40px;"/>
                            </g>
                        </g>
                    </g>
                </svg>
