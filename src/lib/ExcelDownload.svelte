...
<a  {href} class="flex flex-col items-center space-y-1 border-green-600 border-2 text-green-600 shadow-md hover:shadow-lg p-2 rounded-md hover:-translate-y-0.5 duration-200 mx-auto max-w-min leading-tight text-xs">
